...
try {
  ...
  console.log('❌ Erreur lors de la vérification de syntaxe:', error.message, '\n');
}
...
try {
  ...
  if (fs.existsSync(envFile)) {
    ...
    console.log(`  📊 ${varsFound}/${requiredVars.length} variables configurées`);
...
console.log('2. Déployez les schémas de base de données avec install-ab-testing.sh');
console.log('3. Démarrez votre application Next.js');
console.log('4. Visitez /testing/ab-demo pour tester l\'interface');
console.log('5. Exécutez node scripts/test-ab-system.js pour les tests complets');
