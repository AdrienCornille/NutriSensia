-- Script SQL pour créer la table des témoignages
...
-- Politique pour l'administration (à adapter selon votre système d'auth)
CREATE POLICY "Testimonials are manageable by admins" ON testimonials
    FOR ALL USING (
