...
const nutritionistProfile = {
  ...
  consultation_rates: { /* voir consultationRatesSchema */ },
  practice_address: { /* voir practiceAddressSchema */ },
  verified: true,
  is_active: true,
  max_patients: 100
};
...
const patientProfile = {
  ...
  gender: "female",
  emergency_contact: { /* voir emergencyContactSchema */ },
  height: 165,
  initial_weight: 70,
  target_weight: 65,
  ...
  package_credits: { /* voir packageCreditsSchema */ }
};
```
