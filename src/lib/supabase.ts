...
export const db = {
  ...
  meals: {
    ...
    create: async (mealData: Database['public']['Tables']['meals']['Insert']) => {
      const { data, error } = await supabase
        .from('meals')
        .insert(mealData)
        .select()
    ...
    update: async (mealId: string, updates: Database['public']['Tables']['meals']['Update']) => {
      const { data, error } = await supabase
        .from('meals')
        .update(updates)
        .eq('id', mealId)
  ...
  mealPlans: {
    ...
    create: async (planData: Database['public']['Tables']['meal_plans']['Insert']) => {
      const { data, error } = await supabase
        .from('meal_plans')
        .insert(planData)
        .select()
    ...
    update: async (planId: string, updates: Database['public']['Tables']['meal_plans']['Update']) => {
      const { data, error } = await supabase
        .from('meal_plans')
        .update(updates)
        .eq('id', planId)
