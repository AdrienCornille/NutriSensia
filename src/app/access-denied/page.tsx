      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <div className="mb-6">
          <p className="text-gray-600 mb-4">
            Vous n'avez pas les permissions nécessaires pour accéder aux pages de démonstration A/B Testing.
          </p>
              ...
              {reason && (
                <div>
                  ...
                  <span className="ml-2 text-gray-700">
                    {reason === 'admin_required' ? 'Permissions administrateur requises' : reason}
                  </span>
                </div>
              )}
            </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <h3 className="font-medium text-blue-900 mb-2">🔧 Mode développement</h3>
          <p className="text-sm text-blue-800 mb-2">
            Pour tester l'accès administrateur, ajoutez le paramètre <code>?role=admin</code> à l'URL.
          </p>
          <div className="text-xs text-blue-700 space-y-1">
            <p>• <strong>Accès admin :</strong> <code>/testing/ab-demo?role=admin</code></p>
            <p>• <strong>Accès refusé :</strong> <code>/testing/ab-demo?role=nutritionist</code></p>
          </div>
        </div>
