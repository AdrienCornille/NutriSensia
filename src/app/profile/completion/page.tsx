...
export default function ProfileCompletionPage() {
  ...
  const switchRole = () => {
    ...
    setUserRole(newRole);
    setProfileData(newRole === 'nutritionist' ? exampleNutritionistData : examplePatientData);
  };
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-600">
                Rôle actuel: <strong>{userRole === 'nutritionist' ? 'Nutritionniste' : 'Patient'}</strong>
              </div>
              <button
                onClick={switchRole}
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="space-y-2">
              <h3 className="font-medium text-gray-900">Calcul de complétude</h3>
            ...
            <div className="space-y-2">
              <h3 className="font-medium text-gray-900">Interface utilisateur</h3>
              <ul className="text-sm text-gray-600 space-y-1">
