          ...
          <div className="bg-white rounded-lg shadow-sm">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold text-gray-900">Analytics & Rapports</h2>
              </div>
            </div>
            <div className="p-6">
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Analytics d'Onboarding</h3>
                    <p className="text-sm text-gray-500">Métriques et analyses du processus d'onboarding</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Démo A/B Testing (Complète)</h3>
                    <p className="text-sm text-gray-500">Interface complète de démonstration des tests A/B</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Démo A/B Testing (Basique)</h3>
                    <p className="text-sm text-gray-500">Version simplifiée avec métriques statiques</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Démo A/B Testing (Simple)</h3>
                    <p className="text-sm text-gray-500">Version ultra-simplifiée pour tests rapides</p>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold text-gray-900">Gestion & Administration</h2>
              </div>
            </div>
            <div className="p-6">
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Gérer les comptes utilisateurs et leurs rôles</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Configuration générale de l'application</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Gestion et maintenance de la base de données</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Consulter les logs et événements système</p>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="flex items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <span className="font-medium text-blue-900">Générer Rapport</span>
              </button>
              ...
              <button className="flex items-center justify-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                ...
                <span className="font-medium text-green-900">Nouveau Test A/B</span>
              </button>
              ...
              <button className="flex items-center justify-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                ...
                <span className="font-medium text-purple-900">Ajouter Utilisateur</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{userStats.byRole.admin}</div>
                <div className="text-sm text-gray-500">Administrateurs</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">{userStats.byRole.nutritionist}</div>
                <div className="text-sm text-gray-500">Nutritionnistes</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">{userStats.byRole.patient}</div>
