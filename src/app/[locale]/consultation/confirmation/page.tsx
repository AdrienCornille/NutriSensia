...
const nextSteps = [
  {
    ...
    description:
      'Vous recevrez un email de confirmation avec le lien de la visioconférence.',
  },
  {
    number: 2,
    title: 'Préparez vos questions',
    description:
      'Notez vos objectifs, habitudes alimentaires et questions pour optimiser notre échange.',
  },
  {
    number: 3,
              ...
              <CardContent className='p-6'>
                ...
                <div className='space-y-3 text-sm'>
                  <div className='flex justify-between py-2 border-b border-[#E5DED6]'>
                    ...
                    <span className='font-medium text-[#2C3E3C]'>
