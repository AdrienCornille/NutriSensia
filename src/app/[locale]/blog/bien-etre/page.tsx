...
/**
 * Page Catégorie Bien-être - NutriSensia
 */
...
// Articles de la catégorie Bien-être
const bienEtreArticles: Article[] = [
  {
...
export default function BienEtrePage() {
  ...
  return (
    ...
    >
      ...
      <CategoryNavBar activeCategory='bien-etre' topOffset='80px' />
      ...
      <main className='pt-8 pb-24'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <span style={{ color: '#1a1a1a' }}>Bien-être</span>
          </div>
          ...
          >
            ...
            >
              Trouvez l'équilibre entre corps et esprit avec nos conseils sur la
              gestion du stress, le sommeil, la méditation et les habitudes de
              vie saines.
            </p>
          </motion.div>
