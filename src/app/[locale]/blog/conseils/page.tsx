...
/**
 * Page Catégorie Conseils pratiques - NutriSensia
 */
...
// Articles de la catégorie Conseils pratiques
const conseilsArticles: Article[] = [
  {
...
export default function ConseilsPage() {
  ...
  return (
    ...
    >
      ...
      <CategoryNavBar activeCategory='conseils' topOffset='80px' />
      ...
      <main className='pt-8 pb-24'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <span style={{ color: '#1a1a1a' }}>Conseils pratiques</span>
          </div>
          ...
          >
            ...
            >
              Des astuces concrètes et applicables au quotidien pour améliorer
              votre alimentation, organiser vos repas et faire des choix
              éclairés.
            </p>
          </motion.div>
