...
import type { PlanMealType, ModificationRequestData, ModificationRequestFormData, ShoppingList } from '@/types/meal-plan';
import {
  getDailyPlanData,
  getWeeklyPlanData,
  getPlanInfo,
...
export default function MealPlanPage() {
  ...
  const [modificationRequests, setModificationRequests] = useState<ModificationRequestData[]>(
    () => getModificationRequests()
  );
  ...
  const handleSubmitModificationRequest = useCallback((data: ModificationRequestFormData) => {
