...
import type { Recipe, RecipesTab, RecipeFilters as RecipeFiltersType } from '@/types/recipes';
...
export default function RecipesPage() {
  ...
  const handleAddToShoppingList = useCallback((recipe: Recipe) => {
    if (recipe.ingredients) {
      dispatch({ type: 'ADD_RECIPE_TO_SHOPPING_LIST', ingredients: recipe.ingredients });
    }
    dispatch({ type: 'CLOSE_RECIPE_MODAL' });
  }, []);
  ...
  return (
    <div className="min-h-screen">
      ...
      <RecipeModal
        ...
        isFavorite={state.selectedRecipe ? state.favorites.includes(state.selectedRecipe.id) : false}
