...
export function StreakCard({
  ...
  if (variant === 'large') {
    return (
      <div className={`bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-200 ${className}`}>
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex-1">
        <p className="text-lg font-bold text-gray-800">{streak.current} jours</p>
