...
export function BadgeCollection({ badges, onBadgeClick, className = '' }: BadgeCollectionProps) {
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm mb-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-gray-800">Ma collection de badges</h3>
            <p className="text-sm text-gray-500">
              {unlockedCount} sur {badges.length} badges débloqués
            </p>
          </div>
          <div className="text-right">
            <p className="text-2xl font-bold text-[#1B998B]">{progressPercent}%</p>
