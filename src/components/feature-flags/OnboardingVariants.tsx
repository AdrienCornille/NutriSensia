      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='max-w-2xl mx-auto mt-6'>
          ...
          <div className='mt-4 text-center text-sm text-gray-600'>
            💡 Conseil: Prenez votre temps pour remplir chaque section avec
            précision
          </div>
        </div>
      </div>
...
function getHelpContent(stepName: string): string {
  const helpTexts: Record<string, string> = {
    welcome:
      "Bienvenue ! Cette première étape vous présente le processus d'inscription.",
    'personal-info':
      "Renseignez vos informations personnelles. Ces données sont sécurisées et ne seront partagées qu'avec vos patients.",
    credentials:
      'Vos identifiants professionnels nous permettent de vérifier votre qualité de nutritionniste.',
    'practice-details':
      'Les détails de votre cabinet nous aident à mieux vous référencer.',
    specializations:
      'Vos spécialisations permettent aux patients de mieux vous trouver.',
    rates: 'Définissez vos tarifs pour différents types de consultations.',
    training:
      'Cette formation vous familiarise avec les fonctionnalités de la plateforme.',
    completion: 'Félicitations ! Votre profil est prêt à être activé.',
  };

  return (
    helpTexts[stepName] || "Suivez les instructions à l'écran pour continuer."
  );
}
