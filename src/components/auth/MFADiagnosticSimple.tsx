      ...
      if (sessionData?.session?.user) {
        ...
        if (mfaData && !mfaError) {
          ...
          const hasVerifiedFactors =
            diagnosticResults.factors.hasVerifiedFactors;
  ...
  return (
    <Card className='p-6 max-w-4xl mx-auto'>
      ...
      <div className='flex justify-center mb-6'>
        <Button onClick={runDiagnostic} disabled={isLoading} variant='primary'>
        ...
        <div className='space-y-4'>
          ...
          {results.recommendation && (
            <div className='bg-blue-50 border border-blue-200 p-4 rounded-lg'>
              ...
              <p>
                <strong>Redirection :</strong> {results.recommendation.redirect}
              </p>
              <p>
                <strong>Raison :</strong> {results.recommendation.reason}
              </p>
            </div>
          )}
