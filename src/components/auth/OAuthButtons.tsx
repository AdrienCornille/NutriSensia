...
export const AuthDivider: React.FC = () => {
  return (
    <div className='flex items-center space-x-16dp my-24dp'>
      <div className='flex-1 h-px bg-neutral-border dark:bg-neutral-medium' />
...
export const AuthNavigation: React.FC<{
  ...
  return (
    <div className='text-center mt-24dp'>
      <p className='text-body text-neutral-medium dark:text-neutral-medium'>
        {question}{' '}
        <button
          type='button'
          onClick={() => (window.location.href = href)}
          className='text-primary hover:text-secondary font-medium transition-colors duration-standard'
        >
          {link}
        </button>
      </p>
