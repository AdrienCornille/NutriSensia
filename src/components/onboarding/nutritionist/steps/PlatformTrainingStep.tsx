...
export const PlatformTrainingStep: React.FC<PlatformTrainingStepProps> = ({
  ...
  const completeModule = (moduleId: string) => {
    ...
    onDataChange({
      ...
      platformTrainingCompleted: updatedCompleted.length === TRAINING_MODULES.length,
    });
  };
        ...
        <div className="bg-gray-900 rounded-lg aspect-video flex items-center justify-center">
          <div className="text-center text-white space-y-4">
            ...
            <p className="text-sm text-white/60">
              Dans un vrai environnement, ceci serait une vidéo ou un tutoriel interactif
            </p>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <WizardTip type="info" title="Formation optionnelle mais recommandée">
        <p>
          Cette formation vous aidera à tirer le maximum de NutriSensia dès le début. 
          Vous pouvez la passer maintenant et y revenir plus tard depuis votre tableau de bord.
        </p>
      ...
      {allCompleted && (
        ...
        >
          ...
          <p className="text-sm text-green-700">
            Vous avez terminé tous les modules de formation. 
            Vous êtes maintenant prêt à utiliser NutriSensia efficacement !
          </p>
        </motion.div>
      )}
      ...
      <div className="flex justify-between pt-6">
        ...
        <div className="flex space-x-3">
          ...
          >
            <span>
              {allCompleted ? 'Continuer' : 'Terminer plus tard'}
            </span>
            <ChevronRight className="h-4 w-4" />
          </Button>
        </div>
