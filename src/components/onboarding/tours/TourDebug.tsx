...
export const TourDebug: React.FC = () => {
  ...
  const testSteps = [
    ...
    },
    {
      ...
      content: 'Ce tooltip devrait se repositionner automatiquement à gauche pour éviter le débordement.',
      placement: 'left' as const,
    },
    {
      target: '.debug-bottom-right',
      title: 'Test coin inférieur droit',
      content: 'Ce tooltip devrait s\'afficher en haut pour éviter de sortir de l\'écran.',
