...
export const AnimatedNutritionistWrapper: React.FC<AnimatedNutritionistWrapperProps> = ({
  userId,
  onClose,
  onComplete,
  onProgressSave,
  ...
  const [completionData, setCompletionData] = useState<NutritionistOnboardingData | null>(null);
  ...
  const handleProgressUpdate = (newCompletionPercentage: number, newIsCompleted: boolean) => {
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Créons ensemble votre profil professionnel pour vous connecter avec vos futurs patients.
                Ce parcours ne prendra que quelques minutes.
              </p>
            </motion.div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8">
            Votre profil professionnel est maintenant configuré. Vous pouvez commencer à recevoir des demandes de patients.
          </p>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">
                {isProgressLoading ? 'Chargement...' : `${Math.round(completionPercentage || 0)}% terminé`}
              </div>
            </div>
          </div>
        </div>
      ...
      <SimpleTour
        steps={[
          ...
          },
          {
            ...
            content: 'Complétez chaque étape pour configurer votre profil professionnel.',
