    ...
    <div className='space-y-8'>
      ...
      >
        <WizardTip type='info' title="Votre parcours d'inscription">
          <p>
            L'inscription prend environ <strong>15 minutes</strong> et nous
            permet de créer votre profil nutritionnel personnalisé.
          </p>
      ...
      >
        <p>
          🌟 Prêt à transformer vos habitudes alimentaires ? Commençons cette
          aventure ensemble !
        </p>
      </motion.div>
    </div>
