    ...
    <div className='space-y-6'>
      ...
      >
        ...
        <p className='text-gray-600'>
          Ces informations nous aident à adapter vos recommandations
        </p>
      </motion.div>
      ...
      >
        ...
        <WizardTip type='tip' title='Pourquoi ces questions ?'>
          <p className='text-sm'>
            ...
            Ces informations nous permettent de vous proposer des
            recommandations adaptées à votre rythme de vie.
          </p>
        </WizardTip>
