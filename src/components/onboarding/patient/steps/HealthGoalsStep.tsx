...
const TIMELINE_OPTIONS = [
  ...
  { value: '1-year', label: '1 an', description: 'Changement profond' },
  {
    value: 'long-term',
    label: 'Long terme',
    description: 'Mode de vie permanent',
  },
];
...
export const HealthGoalsStep: React.FC<HealthGoalsStepProps> = ({
  ...
  const showTargetWeight =
    selectedPrimaryGoals.includes('weight-loss') ||
        ...
        >
          <WizardTip type='tip' title='Conseils pour définir vos objectifs'>
            <ul className='space-y-1 text-sm'>
              <li>
                • Soyez <strong>réaliste</strong> : des objectifs atteignables
                vous motivent
              </li>
              <li>
                • Pensez <strong>long terme</strong> : les changements durables
                prennent du temps
              </li>
              <li>
                • Votre nutritionniste vous aidera à <strong>affiner</strong>{' '}
                vos objectifs
              </li>
              <li>
                • Vous pourrez <strong>modifier</strong> vos objectifs à tout
                moment
              </li>
            </ul>
          </WizardTip>
