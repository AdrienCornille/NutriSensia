...
import { X, Bookmark, Share2, Play, Pause, Volume2, VolumeX, Maximize, Eye } from 'lucide-react';
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="bg-gray-900 rounded-2xl aspect-video flex items-center justify-center relative overflow-hidden">
          <div className="text-center">
            ...
            <p className="text-white">{isPlaying ? 'Lecture en cours...' : 'Cliquez pour lire la vidéo'}</p>
          </div>

          {/* Video controls */}
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
            <div className="flex items-center gap-4">
              <button onClick={togglePlay} className="text-white hover:text-[#1B998B] transition-colors">
              ...
              <span className="text-white text-sm whitespace-nowrap">6:12 / 18:00</span>

              <button onClick={toggleMute} className="text-white hover:text-[#1B998B] transition-colors">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2 ${
                isSaved ? 'bg-[#1B998B] text-white' : 'bg-white/10 text-white hover:bg-white/20'
              }`}
            >
