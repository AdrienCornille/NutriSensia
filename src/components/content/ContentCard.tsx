...
export function ContentCard({ content, isSaved, onToggleSave, onClick }: ContentCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-500 mt-2 line-clamp-2">{content.description}</p>
