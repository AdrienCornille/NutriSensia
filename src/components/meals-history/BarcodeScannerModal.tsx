...
import { X, Camera, Upload, AlertCircle, CheckCircle, Loader2 } from 'lucide-react';
...
type ScannerState = 'initializing' | 'scanning' | 'found' | 'not_found' | 'error';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-6">
              {/* Scanner view */}
              {(scannerState === 'initializing' || scannerState === 'scanning') && (
              ...
              {scannerState === 'not_found' && (
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-500 text-center">
                    Ce produit n&apos;est pas dans notre base de données.
                    Vous pouvez le rechercher manuellement.
                  </p>
