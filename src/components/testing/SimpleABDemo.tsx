      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <div className="text-2xl font-bold text-blue-900">{testStats.users}</div>
            </div>
            
            <div className="bg-green-50 rounded-lg p-4">
              <div className="text-sm font-medium text-green-900 mb-1">Conversions</div>
              <div className="text-2xl font-bold text-green-900">{testStats.conversions}</div>
            </div>
            
            <div className="bg-purple-50 rounded-lg p-4">
              <div className="text-sm font-medium text-purple-900 mb-1">Durée</div>
              <div className="text-2xl font-bold text-purple-900">
                {Math.floor(testStats.duration / 60)}:{(testStats.duration % 60).toString().padStart(2, '0')}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { key: 'control', name: 'Contrôle', description: 'Version standard actuelle', color: 'bg-gray-100' },
              { key: 'simplified', name: 'Simplifiée', description: 'Interface épurée', color: 'bg-blue-100' },
              { key: 'gamified', name: 'Gamifiée', description: 'Éléments de jeu', color: 'bg-purple-100' },
              { key: 'guided', name: 'Guidée', description: 'Aide contextuelle', color: 'bg-green-100' },
            ].map(variant => (
          ...
          <div className="space-y-4">
            <div className="p-4 border border-gray-200 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Vérifiez que les utilisateurs reçoivent des variantes de manière cohérente.
              </p>
        ...
        <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <div className="text-sm text-yellow-800 space-y-1">
            <p>1. Cliquez sur "Démarrer le test" pour commencer la simulation</p>
