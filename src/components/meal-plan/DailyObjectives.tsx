 ...
 */
function MicronutrientProgressBar({ nutrient }: { nutrient: Micronutrient }) {
  ...
  return (
    <div className='p-3 bg-gray-50 rounded-lg'>
      <div className='flex items-center justify-between mb-2'>
        ...
        <span
          className={`text-xs px-2 py-0.5 rounded-full font-medium ${getStatusBadgeStyle(nutrient.status)}`}
        >
            ...
            <>
              ...
              {micronutrientStats.low > 0 && (
                <span className='px-1.5 py-0.5 bg-red-100 text-red-700 text-xs rounded-full'>
                  {micronutrientStats.low} insuffisant
                  {micronutrientStats.low > 1 ? 's' : ''}
                </span>
              )}
              {micronutrientStats.warning > 0 &&
                micronutrientStats.low === 0 && (
            ...
            <div className='flex items-center gap-3 text-xs'>
              <span className='flex items-center gap-1'>
                ...
                <span className='text-gray-500'>
                  {micronutrientStats.good} optimal
                </span>
              </span>
              <span className='flex items-center gap-1'>
