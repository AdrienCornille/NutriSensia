...
import type { PlanMeal, PlanMealType, PlanFood, FoodAlternative } from '@/types/meal-plan';
                    ...
                    >
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-2">
                          ...
                          >
                            {formatCalorieDifference(food.calories, alt.calories)}
                          </span>
                        </div>
                        <p className="text-xs text-gray-400">
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            ...
            <p className="text-xs text-gray-500">
              P: {mealTotal.protein.toFixed(0)}g • G: {mealTotal.carbs.toFixed(0)}g • L:{' '}
              ...
              {meal.alternatives && (
                <div className="mt-4 p-3 bg-[#1B998B]/10 rounded-lg border border-[#1B998B]/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-[#1B998B]">Alternatives possibles</p>
                      <p className="text-sm text-[#1B998B]/80 mt-1">{meal.alternatives}</p>
                    </div>
                  </div>
                </div>
              )}
