...
import type { ModificationRequestData, ModificationRequestFormData } from '@/types/meal-plan';
import { modificationStatusConfig, formatRelativeDate } from '@/types/meal-plan';
        ...
        {isExpanded && (
          ...
          >
            <div className="px-4 pb-4 border-t border-gray-100 pt-3">
              {/* Full reason */}
              <div className="mb-3">
                <p className="text-xs font-medium text-gray-500 mb-1">Votre demande</p>
              ...
              {hasResponse && (
                <div className="bg-[#1B998B]/5 rounded-lg p-3 border border-[#1B998B]/10">
                  ...
                  <p className="text-sm text-gray-700">{request.nutritionistResponse}</p>
                </div>
              )}
              ...
              {!hasResponse && request.status === 'pending' && (
                <div className="bg-amber-50 rounded-lg p-3 border border-amber-100">
                  <p className="text-sm text-amber-700">
                    Votre nutritionniste n&apos;a pas encore répondu à cette demande.
                  </p>
                </div>
              )}
            </div>
...
export function ModificationRequest({ requests, onSubmitRequest }: ModificationRequestProps) {
