          ...
          <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 mb-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span>
                ...
                {isExpired && <span className="text-red-600 ml-1">(Expiré)</span>}
              </span>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <div className="space-y-1 text-gray-600">
                  <div>ID Export: <code className="bg-gray-100 px-1 rounded">{entry.exportId}</code></div>
                  <div>Format: {entry.format}</div>
                  {entry.lastDownloadAt && (
                    <div>Dernier téléchargement: {formatDate(entry.lastDownloadAt)}</div>
                  )}
                </div>
              </div>

              <div>
                <h4 className="font-medium text-gray-900 mb-2">Sections exportées</h4>
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-2">Sécurité et audit</h4>
                <div className="space-y-1 text-gray-600">
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Chiffré: {entry.sections.includes('encrypted' as any) ? 'Oui' : 'Non'}</span>
                  </div>
                </div>
              </div>
    ...
    <div className="bg-white rounded-lg border">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">
              {filteredHistory.length} export{filteredHistory.length > 1 ? 's' : ''} trouvé{filteredHistory.length > 1 ? 's' : ''}
            </p>
          </div>
      ...
      <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 rounded-b-lg">
        <div className="flex items-start space-x-2">
          ...
          <div>
            <h4 className="text-sm font-medium text-gray-900">Conformité RGPD</h4>
            <p className="text-xs text-gray-600 mt-1">
              Vos exports sont conservés 7 jours puis automatiquement supprimés. 
              Vous pouvez télécharger vos données à tout moment pendant cette période.
            </p>
          </div>
        </div>
      </div>
