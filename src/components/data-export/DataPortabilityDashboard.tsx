...
const QuickStats = () => {
  ...
  const stats = {
    ...
    completedExports: history?.filter(h => h.status === 'completed').length || 0,
    activeDownloads: history?.filter(h => 
      h.status === 'completed' && new Date() < h.expiresAt
    ).length || 0,
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="text-2xl font-bold text-blue-900">{stats.totalExports}</div>
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="text-2xl font-bold text-green-900">{stats.completedExports}</div>
      ...
      <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="text-2xl font-bold text-orange-900">{stats.activeDownloads}</div>
            <div className="text-sm text-orange-700">Téléchargements actifs</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="text-2xl font-bold text-purple-900">{formatSize(stats.dataSize)}</div>
...
export const DataPortabilityDashboard = ({ 
  ...
  const [currentView, setCurrentView] = useState<'overview' | 'export' | 'import' | 'history'>(initialView);
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <ActionCard
                  ...
                  onClick={() => {/* Implémenter les paramètres */}}
                  color="orange"
                  disabled={true}
                />
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-700 space-y-2">
                    <p>
                      <strong>Rétention des données :</strong> Les fichiers d'export sont conservés 7 jours 
                      puis automatiquement supprimés pour garantir votre sécurité.
                    </p>
                    <p>
                      <strong>Chiffrement :</strong> Vous pouvez choisir de chiffrer vos exports avec un mot de passe 
                      pour une sécurité renforcée.
                    </p>
                    <p>
                      <strong>Conformité :</strong> Tous nos processus respectent les exigences du RGPD 
                      en matière de portabilité des données.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-sm text-gray-600">
            ...
            <p className="mt-1">
              ...
              <a href="mailto:privacy@nutrisensia.com" className="text-blue-600 hover:text-blue-700">
