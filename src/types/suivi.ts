...
export const timeRangesConfig: TimeRange[] = [
  '1S',
  '1M',
  '3M',
  '6M',
...
export const measurementTypeConfig: Record<
  MeasurementType,
...
export function calculateWeightProgress(
  ...
  return Math.min(
    Math.max(Math.round((actualChange / totalChange) * 100), 0),
    100
  );
}
 ...
 */
export function getWeightTrendColor(
  trend: WeightTrend,
  isLoss: boolean
): string {
