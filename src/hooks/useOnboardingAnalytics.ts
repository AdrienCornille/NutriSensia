...
export function useOnboardingAnalytics({
  ...
  const trackStepStarted = useCallback(
    (step: string, stepNumber: number) => {
      ...
      onboardingAnalytics.trackStepStarted(
        step,
        stepNumber,
        totalSteps,
        role,
  ...
  const trackStepCompleted = useCallback(
    (step: string, stepNumber: number, completionPercentage: number) => {
  ...
  const trackStepSkipped = useCallback(
    (step: string, stepNumber: number, reason?: string) => {
  ...
  const trackHelpRequested = useCallback(
    (step: string, stepNumber: number, helpType: HelpType) => {
