...
export function showMFAChanges(): void {
  ...
  console.log('  • Nutritionnistes : 2FA obligatoire (nextLevel === "aal2" && currentLevel === "aal1")');
  console.log('  • Patients : 2FA optionnel (nextLevel === "aal2" && currentLevel === "aal1")\n');
  
  console.log('✅ APRÈS (comportement forcé uniforme) :');
  console.log('  • Nutritionnistes : 2FA obligatoire (nextLevel === "aal2" && currentLevel === "aal1")');
  console.log('  • Patients : 2FA FORCÉ (currentLevel === "aal1") - NOUVEAU !\n');
  
  console.log('🎯 Résultat :');
  console.log('  • Tous les utilisateurs ont maintenant le même niveau de sécurité');
  console.log('  • Les patients sont redirigés vers 2FA comme les nutritionnistes');
